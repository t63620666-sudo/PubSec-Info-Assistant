...
class SearchManager:
    ...
    async def create_video_analysis_index(self, vectorizers: Optional[List[VectorSearchVectorizer]] = None):
        logger.info("Checking whether search index %s exists...", self.search_info.index_name)
        ...
        async with self.search_info.create_search_index_client() as search_index_client:
            ...
            if self.search_info.index_name not in [name async for name in search_index_client.list_index_names()]:
                ...
                fields = [
                    ...
                    SimpleField(name="start_timestamp", type="Edm.String", filterable=True, facetable=False),
                    SimpleField(
                        name="end_timestamp",
                            ...
                            SemanticConfiguration(
                                ...
                                prioritized_fields=SemanticPrioritizedFields(
                                    ...
                                    content_fields=[
                                        ...
                                        SemanticField(field_name="actions"),
                                    ],
                                    keywords_fields=[
                                        SemanticField(field_name="key_objects"),
                                        SemanticField(field_name="characters"),
                                        SemanticField(field_name="scene_theme"),
